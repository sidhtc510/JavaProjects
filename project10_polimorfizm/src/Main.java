public class Main {
    ...
    Полиморфизм(с древнегреч. - многоформие) - один из 3 основных припципов объектно-ориентированного программирования(ООП)
        Заключается в том, что можно создавать методы с одинаковым названием, но разными параметрами, чтобы их можно было различать. Идентификация происходить по параметрам которые мы передаем методу. 
        Широкое применение имеет при создании конструкторов класса - часта один тип логически может требовать
